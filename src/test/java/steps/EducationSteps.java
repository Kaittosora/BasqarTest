...
public class EducationSteps {
    ...
    public void enter_the_username_and_password_and_click_on_login_button() {
        ...
        try {
            ...
            System.out.println("there is not Got It button");
        }
    }
    ...
    public void userCreateASubjectAsAndChooseMySubjectCatAsACategory(String subjectName, String code,String category) {
        ...
        table.findElementAndSendKeysFunction("CodeInput",code);
        edu.findElementAndClickFunction("subjectCatInSubject");
        edu.clickOnElementInTheDropdown(category);
        edu.findElementAndClickFunction("style");
        edu.findElementAndClickFunction("styleColor");
        table.findElementAndClickFunction("SaveButton");
    ...
    @When("^User delete \"([^\"]*)\"$")
    public void userDelete(String categoryName) throws InterruptedException {
        Thread.sleep(2000);
